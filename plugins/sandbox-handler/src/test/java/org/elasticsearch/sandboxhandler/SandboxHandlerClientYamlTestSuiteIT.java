...
/**
 * {@link SandboxHandlerClientYamlTestSuiteIT} executes the plugin's REST API integration tests.
 * <p>
 ...
 * </p>
 */
public class SandboxHandlerClientYamlTestSuiteIT extends ESClientYamlSuiteTestCase {

    public SandboxHandlerClientYamlTestSuiteIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
